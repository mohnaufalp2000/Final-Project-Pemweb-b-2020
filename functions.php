<?php
    ...
    // $db_result = mysqli_query($db_connect, "SELECT * FROM mahasiswa");

    // mysqli_fetch_row() // mengembalikan array (numerik)
    // mysqli_fetch_assoc() // mengembalikan array (associative)
    // mysql_fetch_array() // mengembalikan kedua point atas

    // while($mhs = mysqli_fetch_assoc($db_result)){
    //     var_dump($mhs);
    // };
    ...
    function upload(){
        ...
        // Pisah image_name sesuai DELIMITER (.)
        //  luthfi.jpg -> [luthfi][jpg]
        $mhs_upload_image_ext = explode('.',$mhs_upload_image_name);

        // Pick name image after (.) at the end of image_name
        // luthfi.rohman.jpg --> [luthfi][rohman][jpg] make sure the end name
        // strtolower --> make the end name to lower JPG --> jpg
